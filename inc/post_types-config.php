...
if (class_exists('STM_PostType')) {
    $defaultPostTypesOptions = array(
        ...
        // ),
        'stm_works' => array(
            'title' => consulting_theme_option('post_type_works_title', esc_html__('Case Studies', 'consulting')),
            'plural_title' => consulting_theme_option('post_type_works_plural', esc_html__('Case Studies', 'consulting')),
            'all_items' => consulting_theme_option('post_type_works_all_items', esc_html__('All Case Studies', 'consulting')),
