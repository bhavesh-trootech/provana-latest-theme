 ...
 if( !is_404() ): ?>
    ...
    <?php
        ...
        if( $footer_style === 'style_3' ):
            ...
            <footer id="footer" class="footer<?php echo esc_attr( $footer_class ); ?> <?php if($apply_conditional_menu == 1) { echo "main_new_footer"; } ?>">
                            ...
                            <div class="footer_widgets">
                                <div class="row">
                                    ...
                                    for( $count = 1; $count <= 3; $count++ ): ?>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 <?php if( $count == 1 ){ echo "first_col"; } ?>">
                                            <?php if( $count == 1 ): ?>
                                            ...
                                            <?php endif; ?>
                                             <?php if( $count == 2 ): ?>
                                                 <?php dynamic_sidebar( 'new_site_footer1' ); ?>
                                             <?php endif; ?>
                                             <?php if( $count == 3 ): ?>
                                                 <?php dynamic_sidebar( 'new_site_footer2' ); ?>
                                             <?php endif; ?>
...
jQuery(document).ready(function(){
    ...
    function solutionMenuScroll() {
         if (jQuery(window).width() < 1025) {

            jQuery('#menu-item-15740 .arrow').on('click', function (e) {
                e.preventDefault();
            ...
            jQuery('#menu-item-15731 .arrow').on('click', function (e) {
                e.preventDefault();
            ...
            jQuery('#menu-item-15684 .arrow,#menu-item-15731 .arrow').on('click', function (e) {
                e.preventDefault();

               

                if ( jQuery(this).hasClass("active") ) {   
                    //console.log('actggivvv');
                    jQuery('html, body').css({
                        overflow: 'unset',
                        height: 'unset'
                    }); 
...
jQuery(document).ready(function () {
    ...
    jQuery(".clickToExploreBtn a").click(function () {
        jQuery(this).hide();
        jQuery(".fen_active_content_box").show();
        jQuery(".agaentScoredInner").addClass("popupContents");
...
<script type="text/javascript" id="hs-script-loader" async defer src="//js.hs-scripts.com/4398512.js"></script>
