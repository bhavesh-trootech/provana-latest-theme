    ...
    <div class="<?php echo esc_attr( $css_class ); ?>" id="<?php echo esc_attr( $id ); ?>">
        <?php while ( $testimonials->have_posts() ): $testimonials->the_post(); ?>
            ...
            <?php if( stm_check_layout( 'layout_14' ) || stm_check_layout( 'layout_lyon' ) and !$disable_carousel ): ?>
                <div class="testimonial casestyudf13">
            ...
            <?php elseif( ( stm_check_layout( 'layout_15' )
                ...
                ?>
                <div class="testimonial casestyudf1" <?php echo sanitize_text_field( $bg_image ); ?>>
                    <div class="info">
                        <div class="container">
            ...
            <?php else: ?>
                <div class="testimonial casestyudf2">
                 <div class="troodesctroodiv">
                    <?php

                    $author_photo = consulting_get_image( get_post_thumbnail_id(), $thumb_size );
                    ?>
                    <div class="image casestyimgc">
                       
                            <a href="<?php echo get_the_permalink(); ?>"><?php echo consulting_filtered_output( $author_photo ); ?></a>
                      
                    </div>
                    <div class="info desctroodiv">
                        <h4 class="no_stripe titlecasestudyc">
                                <a href="<?php echo get_the_permalink(); ?>">
                                    <?php  echo wp_trim_words( get_the_title(), 8 ); ?>
                                </a>
                        </h4>
                        <div class="troo_case_cdesc"><?php 
                        $count=180;
